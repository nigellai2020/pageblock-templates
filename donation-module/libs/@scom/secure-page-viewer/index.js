...
define("@scom/secure-page-viewer/pageElement.tsx", ["require", "exports", "@ijstech/components", "@scom/secure-page-viewer/utils.ts", "@scom/secure-page-viewer/store/index.ts"], function (require, exports, components_8, utils_1, index_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let ViewrPageElement = class ViewrPageElement extends components_8.Module {
        ...
        async loadModule(rootDir, options) {
            ...
            if (options.localPath) {
                const localRootPath = `${rootDir}/${options.localPath}`;
